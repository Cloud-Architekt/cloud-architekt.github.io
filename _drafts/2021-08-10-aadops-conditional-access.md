...
![../2021-08-10-aadops-conditional-access/aadops.png](../2021-08-10-aadops-conditional-access/aadops.png)
...
![../2021-08-10-aadops-conditional-access/aadops1.png](../2021-08-10-aadops-conditional-access/aadops1.png)

![../2021-08-10-aadops-conditional-access/aadops2.png](../2021-08-10-aadops-conditional-access/aadops2.png)
...
![../2021-08-10-aadops-conditional-access/aadops3.png](../2021-08-10-aadops-conditional-access/aadops3.png)
...
![../2021-08-10-aadops-conditional-access/aadops4.png](../2021-08-10-aadops-conditional-access/aadops4.png)
...
- **AAD_CA**: Current configuration of the deployed policies are stored here. Each policy is named with the object ID of the certain staging/tenant and stored in a flat hierarchy. JSON files will be also updated as part of the pull pipeline ("Policy-Pull"). This ensures that the latest version of the configured policies are stored in the repository, even if a manual change in the Azure Portal was made. Changed policy files will be validated and added as build artifacts by the "Policies-CI".
    ...
    ![../2021-08-10-aadops-conditional-access/aadops5.png](../2021-08-10-aadops-conditional-access/aadops5.png)
...
- **AAD_CA_Templates:** Templates across all environments (tenants) are located in this folder. Subfolder can be used to split the various templates in personas/groups/access levels. Changes to this folder will trigger continuous integration of the build pipeline "Templates-CI".
    ...
    ![../2021-08-10-aadops-conditional-access/aadops6.png](../2021-08-10-aadops-conditional-access/aadops6.png)
...
![../2021-08-10-aadops-conditional-access/aadops7.png](../2021-08-10-aadops-conditional-access/aadops7.png)
...
![../2021-08-10-aadops-conditional-access/aadops8.png](../2021-08-10-aadops-conditional-access/aadops8.png)
...
![../2021-08-10-aadops-conditional-access/aadops9.png](../2021-08-10-aadops-conditional-access/aadops9.png)

Member of the "Identity Ops"-Team needs to review the changes of the policies and templates before the PR will be completed. In this case, I'm following the double­-check principle for an appropriate quality control and approval process on the important assets in the "Zero Trust Policy."

![../2021-08-10-aadops-conditional-access/aadops10.png](../2021-08-10-aadops-conditional-access/aadops10.png)
...
![../2021-08-10-aadops-conditional-access/aadops11.png](../2021-08-10-aadops-conditional-access/aadops11.png)
...
![../2021-08-10-aadops-conditional-access/aadops12.png](../2021-08-10-aadops-conditional-access/aadops12.png)

After coding the policy, a pull request will be created to the "main" branch:

![../2021-08-10-aadops-conditional-access/aadops13.png](../2021-08-10-aadops-conditional-access/aadops13.png)

As we can see, the reviewers and approval checks will be triggered automatically:

![../2021-08-10-aadops-conditional-access/aadops14.png](../2021-08-10-aadops-conditional-access/aadops14.png)

If the PR request was completed, the work item will be updated with links to the various development activities:

![../2021-08-10-aadops-conditional-access/aadops15.png](../2021-08-10-aadops-conditional-access/aadops15.png)

## Build: Verify JSON and publish pipeline artifacts

![../2021-08-10-aadops-conditional-access/aadops16.png](../2021-08-10-aadops-conditional-access/aadops16.png)
...
![../2021-08-10-aadops-conditional-access/aadops17.png](../2021-08-10-aadops-conditional-access/aadops17.png)
...
[Build tags](https://docs.microsoft.com/en-us/rest/api/azure/devops/build/tags/add%20build%20tag?WT.mc_id=AZ-MVP-5003945) can be added during the build process which allows filtering artifacts (from the same build branch) on the continuous deployment trigger (release pipelines). 
...
![../2021-08-10-aadops-conditional-access/aadops18.png](../2021-08-10-aadops-conditional-access/aadops18.png)
...
![../2021-08-10-aadops-conditional-access/aadops19.png](../2021-08-10-aadops-conditional-access/aadops19.png)

## Push Pipeline: Deployment of CA changes

![../2021-08-10-aadops-conditional-access/aadops20.png](../2021-08-10-aadops-conditional-access/aadops20.png)
...
![../2021-08-10-aadops-conditional-access/aadops21.png](../2021-08-10-aadops-conditional-access/aadops21.png)

Filtering of the target environment will set to the stage-level in the "Policies-Push" pipeline:

![../2021-08-10-aadops-conditional-access/aadops22.png](../2021-08-10-aadops-conditional-access/aadops22.png)
...
![../2021-08-10-aadops-conditional-access/aadops23.png](../2021-08-10-aadops-conditional-access/aadops23.png)
...
![../2021-08-10-aadops-conditional-access/aadops24.png](../2021-08-10-aadops-conditional-access/aadops24.png)
...
"Azure KeyVault" stores the secrets or certificates (recommended) of the various service principal(s) to get access to the target environments. Managed Identity will be used to receive the secrets from the secret store:
    ...
    ![../2021-08-10-aadops-conditional-access/aadops25.png](../2021-08-10-aadops-conditional-access/aadops25.png)
...
![../2021-08-10-aadops-conditional-access/aadops26.png](../2021-08-10-aadops-conditional-access/aadops26.png)
...
![../2021-08-10-aadops-conditional-access/aadops27.png](../2021-08-10-aadops-conditional-access/aadops27.png)
...
![../2021-08-10-aadops-conditional-access/aadops28.png](../2021-08-10-aadops-conditional-access/aadops28.png)
...
![../2021-08-10-aadops-conditional-access/aadops29.png](../2021-08-10-aadops-conditional-access/aadops29.png)
...
![../2021-08-10-aadops-conditional-access/aadops30.png](../2021-08-10-aadops-conditional-access/aadops30.png)
...
![../2021-08-10-aadops-conditional-access/aadops31.png](../2021-08-10-aadops-conditional-access/aadops31.png)
...
![../2021-08-10-aadops-conditional-access/aadops32.png](../2021-08-10-aadops-conditional-access/aadops32.png)

This includes build validation and reviewer approvals to protect the source of truth ("main" branch in the AADOps repo).

![../2021-08-10-aadops-conditional-access/aadops33.png](../2021-08-10-aadops-conditional-access/aadops33.png)
...
![../2021-08-10-aadops-conditional-access/aadops34.png](../2021-08-10-aadops-conditional-access/aadops34.png)

After the Pull Request has been completed, the push pipeline will be triggered to re-deploy the policy based on the configuration state in AADOps. This ensures that tasks from the "Policies-Push" pipeline will be applied to every "managed" policy which is managed by AADOps. Even they are created or modified outside of AADOps.

Let's take just another sample... back to our original scenario to deploy a new policy.
A member of the IdentityOps-Team has enabled the policy in the "CAN" ring (deployed by the Template-Push pipeline in "Report-only" mode). This was planned at next step after the template deployment.

"Governance/Security Reviewer" will get an notification about this change:

![../2021-08-10-aadops-conditional-access/aadops35.png](../2021-08-10-aadops-conditional-access/aadops35.png)
...
![../2021-08-10-aadops-conditional-access/aadops36.png](../2021-08-10-aadops-conditional-access/aadops36.png)
...
![../2021-08-10-aadops-conditional-access/aadops37.png](../2021-08-10-aadops-conditional-access/aadops37.png)

## AADOps as "serverless"?

Most of the functions and tasks in the AADOps pipelines are based on REST API Calls (to Microsoft Graph or Azure DevOps API). Therefore it would be also possible to trigger those actions as part of a Logic App. In this case, Azure Repos or GitHub can be still used as repository including PR request as trigger. Protection and workflows for the repository (as source of truth) are still in-place but the efforts (and costs) to manage servers (as hosted agents) will be reduced. This solutions seems to be a real „cloud-native“ solution. But on the other hand, compliance and security of a Logic App to manage critical assets on „Control plane“ must be also considered. This includes to enable a similar approval workflows as already described in the DevOps release pipelines (approving deployment to another stage). Conditional statement and various connectors to ITSM or collaboration tools in Logic Apps should allow such kind of integration. Therefore, I would like to build the next PoC of AADOps as serverless solution (with Azure Logic App and/or Azure Functions).
