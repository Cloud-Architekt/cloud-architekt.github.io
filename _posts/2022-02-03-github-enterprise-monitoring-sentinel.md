...
excerpt: "GitHub Enterprise is more than a platform to manage developer's code in a repository. It will be also used to automate deployment of cloud resources and manage infrastructure-as-code. This blog post gives you an overview about ingest audit data, write analytics rules and automate response with the latest solution in Microsoft Sentinel."
header:
  overlay_image: /assets/images/ghesentinel.jpg
  overlay_filter: rgba(102, 102, 153, 0.85)
  teaser: /assets/images/ghesentinel.jpg
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring1.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring2.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring3.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring4.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring5.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring6.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring7.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring8.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring9.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring10.png)

![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring11.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring12.png)
...
- We are using the "Account" entity from the incident (in this case the GitHub account name) to identify the target "GitHub user" for blocking action. Secrets can be (securely) read by using the native KeyVault connector.
    ...
    ![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring13.png)
...
- The second part of the playbook is using a “foreach” function on the list of accounts from the incident entity. Add the HTTP action for the API request to GitHub and choose the secret from the KeyVault as part of the “Authorization” header:
    ...
    ![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring14.png)
    
- Optional: As final step in the playbook, we can add a comment to the incident if blocking the user has been successful.
    
    ![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring15.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring16.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp.png)

Next, we will create a new Logic App with “Microsoft Sentinel alert” trigger and the following actions:

![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp1.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp2.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp3.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp4.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp5.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp6.png)

Downloaded zip file contains all raw logs from the suspicious workflow run and allows to trace the usage of secrets:

![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/logicapp7.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring17.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring18.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring19.png)
...
![Screenshot]({{ site.url }}{{ site.baseurl }}/assets/images/2022-02-03-github-enterprise-monitoring-sentinel/githubmonitoring20.png)
