...
![../2021-08-11-aadops-conditional-access/aadops.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops.png)
...
![../2021-08-11-aadops-conditional-access/aadops1.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops1.png)

![../2021-08-11-aadops-conditional-access/aadops2.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops2.png)
...
![../2021-08-11-aadops-conditional-access/aadops3.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops3.png)
...
![../2021-08-11-aadops-conditional-access/aadops4.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops4.png)
...
- **AAD_CA**: Current configuration of the deployed policies are stored here. Each policy is named with the object ID of the certain staging/tenant and stored in a flat hierarchy. JSON files will be also updated as part of the pull pipeline ("Policy-Pull"). This ensures that the latest version of the configured policies are stored in the repository, even if a manual change in the Azure Portal was made. Changed policy files will be validated and added as build artifacts by the "Policies-CI".
    ...
    ![../2021-08-11-aadops-conditional-access/aadops5.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops5.png)
...
- **AAD_CA_Templates:** Templates across all environments (tenants) are located in this folder. Subfolder can be used to split the various templates in personas/groups/access levels. Changes to this folder will trigger continuous integration of the build pipeline "Templates-CI".
    ...
    ![../2021-08-11-aadops-conditional-access/aadops6.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops6.png)
...
![../2021-08-11-aadops-conditional-access/aadops7.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops7.png)
...
![../2021-08-11-aadops-conditional-access/aadops8.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops8.png)
...
![../2021-08-11-aadops-conditional-access/aadops9.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops9.png)
...
![../2021-08-11-aadops-conditional-access/aadops10.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops10.png)
...
![../2021-08-11-aadops-conditional-access/aadops11.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops11.png)
...
![../2021-08-11-aadops-conditional-access/aadops12.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops12.png)

After coding the policy, a pull request will be created to the "main" branch:

![../2021-08-11-aadops-conditional-access/aadops13.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops13.png)

As we can see, the reviewers and approval checks will be triggered automatically:

![../2021-08-11-aadops-conditional-access/aadops14.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops14.png)

If the PR request was completed, the work item will be updated with links to the various development activities:

![../2021-08-11-aadops-conditional-access/aadops15.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops15.png)

## Build: Verify JSON and publish pipeline artifacts

![../2021-08-11-aadops-conditional-access/aadops16.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops16.png)
...
![../2021-08-11-aadops-conditional-access/aadops17.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops17.png)
...
![../2021-08-11-aadops-conditional-access/aadops18.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops18.png)
...
![../2021-08-11-aadops-conditional-access/aadops19.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops19.png)

## Push Pipeline: Deployment of CA changes

![../2021-08-11-aadops-conditional-access/aadops20.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops20.png)
...
![../2021-08-11-aadops-conditional-access/aadops21.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops21.png)

Filtering of the target environment will set to the stage-level in the "Policies-Push" pipeline:

![../2021-08-11-aadops-conditional-access/aadops22.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops22.png)
...
![../2021-08-11-aadops-conditional-access/aadops23.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops23.png)
...
![../2021-08-11-aadops-conditional-access/aadops24.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops24.png)
...
"Azure KeyVault" stores the secrets or certificates (recommended) of the various service principal(s) to get access to the target environments. Managed Identity will be used to receive the secrets from the secret store:
    ...
    ![../2021-08-11-aadops-conditional-access/aadops25.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops25.png)
...
![../2021-08-11-aadops-conditional-access/aadops26.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops26.png)
...
![../2021-08-11-aadops-conditional-access/aadops27.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops27.png)
...
![../2021-08-11-aadops-conditional-access/aadops28.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops28.png)
...
![../2021-08-11-aadops-conditional-access/aadops29.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops29.png)
...
![../2021-08-11-aadops-conditional-access/aadops30.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops30.png)
...
![../2021-08-11-aadops-conditional-access/aadops31.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops31.png)
...
![../2021-08-11-aadops-conditional-access/aadops32.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops32.png)

This includes build validation and reviewer approvals to protect the source of truth ("main" branch in the AADOps repo).

![../2021-08-11-aadops-conditional-access/aadops33.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops33.png)
...
![../2021-08-11-aadops-conditional-access/aadops34.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops34.png)
...
![../2021-08-11-aadops-conditional-access/aadops35.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops35.png)
...
![../2021-08-11-aadops-conditional-access/aadops36.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops36.png)
...
![../2021-08-11-aadops-conditional-access/aadops37.png]({{ site.url }}{{ site.baseurl }}/assets/images/2021-08-11-aadops-conditional-access/aadops37.png)
