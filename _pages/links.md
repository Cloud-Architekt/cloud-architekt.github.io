...
| Terraform Provider for Azure Active Directory | The Azure Provider can be used to configure infrastructure in Azure Active Directory using the Microsoft Graph API. | hashicorp/azuread | Terraform Registry | Docs overview | hashicorp/azuread | Terraform Registry |
